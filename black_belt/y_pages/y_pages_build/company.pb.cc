...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<5> scc_info_Company_company_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 5, 0, InitDefaultsscc_info_Company_company_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, descriptor_table_protodef_company_2eproto, "company.proto", 308,
...
void Company::clear_working_time() {
  if (GetArena() == nullptr && working_time_ != nullptr) {
