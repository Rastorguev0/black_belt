...
class Signal PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_provider_id() const;
  void _internal_set_provider_id(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_update_date() const;
  void _internal_set_update_date(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Signal::_internal_provider_id() const {
  return provider_id_;
}
...
inline void Signal::_internal_set_provider_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Signal::_internal_update_date() const {
  return update_date_;
}
...
inline void Signal::_internal_set_update_date(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline ::YellowPages::Company* Signal::_internal_mutable_company() {
  ...
  if (company_ == nullptr) {
    auto* p = CreateMaybeMessage<::YellowPages::Company>(GetArena());
    company_ = p;
  }
  return company_;
}
...
inline void Signal::set_allocated_company(::YellowPages::Company* company) {
  ...
  if (company) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(company)->GetArena();
